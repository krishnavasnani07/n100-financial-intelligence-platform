...
st.markdown("<h1 style='font-weight:800;'>📈 Trend Analysis</h1>", unsafe_allow_html=True)
st.markdown("<p style='color:#8892b0; margin-top:-15px;'>Inspect 10-year financial metrics and growth trends for any Nifty 100 company.</p>", unsafe_allow_html=True)
st.markdown("---")
