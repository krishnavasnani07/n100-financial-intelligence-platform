...
st.markdown("<h1 style='font-weight:800;'>🏭 Sector Analysis</h1>", unsafe_allow_html=True)
st.markdown("<p style='color:#8892b0; margin-top:-15px;'>Compare sector landscape and performance distributions among Nifty 100 constituents.</p>", unsafe_allow_html=True)
st.markdown("---")
