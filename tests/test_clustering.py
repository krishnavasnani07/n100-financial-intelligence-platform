...
from src.analytics.clustering import (impute_sector_medians, load_clustering_data,
                                      prepare_features, run_kmeans, assign_cluster_names)
...
def test_impute_sector_medians():
    ...
    test_df = pd.DataFrame({
        ...
        "debt_to_equity": [0.1, 0.2, None, None],  # Finance sector has all NaNs for D/E
    ...
    for col in ["return_on_equity_pct", "debt_to_equity", "revenue_cagr_5yr", "fcf_cagr_5yr", "operating_profit_margin_pct"]:
