...
def test_run_peer_analysis_end_to_end():
    ...
    expected_cols = [
        "Company", "Sector", "Peer Rank", "Composite Score", 
        "ROE Percentile", "ROCE Percentile", "Revenue CAGR Percentile", 
        "PAT CAGR Percentile", "Debt to Equity Percentile", 
        "Operating Margin Percentile", "Interest Coverage Percentile"
    ]
