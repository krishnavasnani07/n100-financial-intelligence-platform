...
def test_opm_cross_check_no_divergence():
    ...
    result = calculate_operating_profit_margin(10, 100, reported_opm=10.0, tolerance=1.0)
...
def test_opm_cross_check_divergence():
    ...
    result = calculate_operating_profit_margin(10, 100, reported_opm=15.0, tolerance=1.0)
    assert result == pytest.approx(10.0)
