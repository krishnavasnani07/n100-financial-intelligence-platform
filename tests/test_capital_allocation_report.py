...
def test_categorize_transition():
    ...
    assert categorize_transition("Growth Funded by Debt", "Distress Signal") == "Negative Shift"
...
def test_verify_capital_allocation():
    ...
    df_valid = pd.DataFrame([
        ...
        {"company_id": "TCS", "year": "Mar 2024", "pattern_label": "Shareholder Returns"}
    ])
    ...
    df_dup = pd.DataFrame([
        {"company_id": "ABB", "year": "Mar 2024", "pattern_label": "Reinvestor"},
        {"company_id": "ABB", "year": "Mar 2024", "pattern_label": "Shareholder Returns"}
    ] * 46) # Repeat to get 92 rows
    errors_dup = verify_capital_allocation(df_dup, DB_PATH)
    assert any("Duplicate" in err for err in errors_dup)

    # Test invalid patterns
    df_invalid = pd.DataFrame([
        {"company_id": "ABB", "year": "Mar 2024", "pattern_label": "InvalidPattern"},
    ] * 92)
